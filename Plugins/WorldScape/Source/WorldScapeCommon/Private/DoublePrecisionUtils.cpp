...
FString DVector4::ToString() const
{
    ...
    outString.append("X:");
    outString.append(std::to_string(this->X));
    outString.append(", ");
    outString.append("Y:");
    outString.append(std::to_string(this->Y));
    outString.append(", ");
    outString.append("Z:");
    outString.append(std::to_string(this->Z));
    outString.append(", ");
    outString.append("W:");
    outString.append(std::to_string(this->W));
...
#if __cplusplus >= 202002L
    //Double Version of the Quake Implementatio nof the Fast InvertSquare from Quake 3
