...
void FWorldScapeFactoryModule::StartupModule()
{
    ...
    ToolBarExtensibilityManager = MakeShareable(new FExtensibilityManager);
        ...
        TSharedPtr<IAssetTypeActions> Action = MakeShareable(new FWorldScapeFoliageTypeAction(WorldScapeCategory));
        AssetTools.RegisterAssetTypeActions(Action.ToSharedRef());

        Action = MakeShareable(new FWorldScapeFoliageCollectionTypeAction(WorldScapeCategory));
        AssetTools.RegisterAssetTypeActions(Action.ToSharedRef());
