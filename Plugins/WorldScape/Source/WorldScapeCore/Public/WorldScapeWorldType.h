...
public:
	...
	static double GetLattitude(FVector Position, FRotator LattitudeRotation, bool FlatWorld, double PlanetScaleCode);

	static void GetSnappedPosition(DVector& SnappedPosition, DVector& HardenNormal, FVector2D& SubPosition, bool NormalBeenChanged, double& StepSize,
		...
		bool flatWorld, bool UpdateHarden = false);
